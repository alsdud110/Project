function checkForm(writeform){
 ...
 function deleteForm(writeform){
	 writeform.submit(writeform.id.value());
	 writeform.submit(writeform.passwd.value());
	 writeform.submit(writeform.name.value());
	 writeform.submit(writeform.tel.value());
	 writeform.submit(writeform.address.value());
	 writeform.action = "deletePro.jsp";
 }
