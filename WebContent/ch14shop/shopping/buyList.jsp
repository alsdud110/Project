   ...
   <table> 
      ...
      <tr> 
        ...
        <td  width="300" align="left">
           <img src="/StudyBasicJSP/imageFile/<%=buyList.getBook_image()%>" 
...
<input type="button" value="메인으로" 
  onclick="javascript:window.location='shopMain.jsp'">
 <input type = "button" value = "삭제하기" onclick = "javascript:window.location = 'buyDel.jsp?buyer=<%=buyList.getBuyer() %>>'">
  </td>
 </tr>
<%
 }
